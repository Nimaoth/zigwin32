...
pub const WAIT_RETURN_CAUSE = enum(u32) {
    OBJECT_0 = 0,
    ABANDONED = 128,
    // ABANDONED_0 = 128, this enum value conflicts with ABANDONED
    IO_COMPLETION = 192,
    TIMEOUT = 258,
    FAILED = 4294967295,
};
...
pub const WAIT_ABANDONED_0 = WAIT_RETURN_CAUSE.ABANDONED;
...
// TODO: this type is limited to platform 'windows6.1'
pub extern "KERNEL32" fn GetCurrentUmsThread() callconv(@import("std").os.windows.WINAPI) *c_void;
...
const PROCESS_MITIGATION_POLICY = @import("../system/system_services.zig").PROCESS_MITIGATION_POLICY;
const HRESULT = @import("../foundation.zig").HRESULT;
const SLIST_HEADER = @import("../system/kernel.zig").SLIST_HEADER;
const IO_COUNTERS = @import("../system/system_services.zig").IO_COUNTERS;
...
const RTL_BARRIER = @import("../system/system_services.zig").RTL_BARRIER;
const PWSTR = @import("../foundation.zig").PWSTR;
const TP_IO = @import("../system/system_services.zig").TP_IO;
...
const PTP_WORK_CALLBACK = @import("../system/system_services.zig").PTP_WORK_CALLBACK;
